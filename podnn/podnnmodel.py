...
class PodnnModel:
    ...
    def generate_dataset(self, u, mu_min, mu_max, n_s,
        ...
        self.save_train_data(X_U_train, U_train, X_U_test, U_test)

        return X_U_train, U_train, X_U_test, U_test
